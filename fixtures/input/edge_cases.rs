...
use serde_json::{Value as JsonValue, json, Map, Number};
use std::io::{Read as R, Write as W, BufRead};
...
use tokio::prelude::*; // Wildcard - always kept even if unused
use std::io::*; // Another wildcard from same crate family

// ═════════════════════════════════════════════════════════════════════════════
// SCENARIO 8: Raw Identifiers
// ═════════════════════════════════════════════════════════════════════════════

use crate::keywords::{r#type as TypeKeyword, r#fn as FnKeyword, r#impl};
...
use std::io::Write; // Used via .write_all()
...
use std::fs::File;
pub use crate::models::Data; // All pub use should be marked isPublic
